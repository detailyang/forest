...
pub static ADDRESS: &actorv5::STORAGE_MARKET_ACTOR_ADDR = &actorv5::STORAGE_MARKET_ACTOR_ADDR;

/// Market actor method.
pub type Method = actorv5::market::Method;
...
impl State {
        ...
        BS: BlockStore,
    {
        match self {
            ...
            State::V5(st) => {
                Ok(actorv5::BalanceTable::from_root(store, &st.locked_table)
                    .map(BalanceTable::V5)?)
            }
        }
    }
